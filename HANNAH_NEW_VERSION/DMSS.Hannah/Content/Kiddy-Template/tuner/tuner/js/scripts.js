...
jQuery(document).ready(function () {
    ...
    jQuery('body').click(function (event) {
        ...
        if (jQuery('#tuner').hasClass('tuner-visible')) {
            jQuery('#tuner').removeClass('tuner-visible');
        }
    });
    jQuery('#tuner-switcher').on('click', function (e) {
        if (jQuery('#tuner').hasClass('tuner-visible')) {
	...
	jQuery('.boxed-switcher').on('click', function(){
        if (jQuery(this).hasClass('boxed_on')) {
            ...
            jQuery('div.page').removeClass('page_boxed');
            sessionStorage.setItem("boxed", "boxed_on");
		}else{
            jQuery(this).addClass('boxed_on');
            jQuery('div.page').addClass('page_boxed');
            sessionStorage.setItem("boxed", "page_boxed");
		}
	});
	...
	jQuery('.style-switcher>*').on('click', function(){
		...
		if (jQuery(this).hasClass("flat-style")) {
			...
			jQuery('.page_title').addClass('flat');
            jQuery('.benefits_area').removeClass('wave');
            sessionStorage.setItem("style", "flat-style");
		}else{
			jQuery('.page').removeClass('page_flat');
			jQuery('.page_title').removeClass('flat');
            jQuery('.benefits_area').addClass('wave');
            sessionStorage.setItem("style", "page_flat");
		};
	});
	...
	jQuery('.menu-switcher>*').on('click', function(){
		...
		if (jQuery(this).hasClass("logo-out-menu")) {
			jQuery('.site_header').addClass('logo-out-menu');
            jQuery('.site_header').removeClass('without-bees');
            sessionStorage.setItem("menu", "logo-out-menu");
		}else if (jQuery(this).hasClass("without-bees")){
			jQuery('.site_header').removeClass('logo-out-menu');
            jQuery('.site_header').addClass('without-bees');
            sessionStorage.setItem("menu", "without-bees");
		}else{
			jQuery('.site_header').removeClass('logo-out-menu');
            jQuery('.site_header').removeClass('without-bees');
            sessionStorage.setItem("menu", "default");
		};
	});
			...
			if ( tuner_el.length && style_el.length ){
				...
				el.ColorPicker({
					...
					onChange: function (hsb, hex, rgb) {
                        ...
                        sessionStorage.setItem("hsb" + index, JSON.stringify(hsb));
                        sessionStorage.setItem("hex" + index, hex);
                        sessionStorage.setItem("rgb" + index, JSON.stringify(rgb));
    ...
    if (sessionStorage.getItem("hsb1") != null && sessionStorage.getItem("hsb1") != '') {

        var tuner_id = 'tuner-style-' + 1;
        var style_id = 'cws-cp-' + 1;
        var tuner_el = jQuery('#' + tuner_id);
        var style_el = jQuery('#' + style_id);
    
        var hsb1 = JSON.parse(sessionStorage.getItem("hsb1"));
        var hex1 = sessionStorage.getItem("hex1");
        var rgb1 = JSON.parse(sessionStorage.getItem("rgb1"));


        tuner_el.find('span').text(hex1);
        style_el.text(tuner_el.text());

        jQuery('#color-1').css('background-color', '#' + hex1);
        canvas_init("1", hsb1, hex1, rgb1);


    }
    if (sessionStorage.getItem("hsb2") != null && sessionStorage.getItem("hsb2") != '') {
        var tuner_id = 'tuner-style-' + 2;
        var style_id = 'cws-cp-' + 2;
        var tuner_el = jQuery('#' + tuner_id);
        var style_el = jQuery('#' + style_id);

        var hsb1 = JSON.parse(sessionStorage.getItem("hsb2"));
        var hex1 = sessionStorage.getItem("hex2");
        var rgb1 = JSON.parse(sessionStorage.getItem("rgb2"));


        tuner_el.find('span').text(hex1);
        style_el.text(tuner_el.text());

        jQuery('#color-2').css('background-color', '#' + hex1);
        canvas_init("2", hsb1, hex1, rgb1);
    }

    if (sessionStorage.getItem("hsb3") != null && sessionStorage.getItem("hsb3") != '') {
        var tuner_id = 'tuner-style-' + 3;
        var style_id = 'cws-cp-' + 3;
        var tuner_el = jQuery('#' + tuner_id);
        var style_el = jQuery('#' + style_id);

        var hsb1 = JSON.parse(sessionStorage.getItem("hsb3"));
        var hex1 = sessionStorage.getItem("hex3");
        var rgb1 = JSON.parse(sessionStorage.getItem("rgb3"));


        tuner_el.find('span').text(hex1);
        style_el.text(tuner_el.text());

        jQuery('#color-3').css('background-color', '#' + hex1);
        canvas_init("3", hsb1, hex1, rgb1);
    }
    if (sessionStorage.getItem("hsb4") != null && sessionStorage.getItem("hsb4") != '') {
        var tuner_id = 'tuner-style-' + 4;
        var style_id = 'cws-cp-' + 4;
        var tuner_el = jQuery('#' + tuner_id);
        var style_el = jQuery('#' + style_id);

        var hsb1 = JSON.parse(sessionStorage.getItem("hsb4"));
        var hex1 = sessionStorage.getItem("hex4");
        var rgb1 = JSON.parse(sessionStorage.getItem("rgb4"));


        tuner_el.find('span').text(hex1);
        style_el.text(tuner_el.text());

        jQuery('#color-4').css('background-color', '#' + hex1);
        canvas_init("4", hsb1, hex1, rgb1);
    }
    if (sessionStorage.getItem("hsb5") != null && sessionStorage.getItem("hsb5") != '') {
        var tuner_id = 'tuner-style-' + 5;
        var style_id = 'cws-cp-' + 5;
        var tuner_el = jQuery('#' + tuner_id);
        var style_el = jQuery('#' + style_id);

        var hsb1 = JSON.parse(sessionStorage.getItem("hsb5"));
        var hex1 = sessionStorage.getItem("hex5");
        var rgb1 = JSON.parse(sessionStorage.getItem("rgb5"));


        tuner_el.find('span').text(hex1);
        style_el.text(tuner_el.text());

        jQuery('#color-5').css('background-color', '#' + hex1);
        canvas_init("5", hsb1, hex1, rgb1);
    }
